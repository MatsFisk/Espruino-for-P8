...
> var spi=new SPI();spi.setup({sck:D2,mosi:D3,miso:D4,mode:0}); spi.send([0xab],D5);  //wake <p>
...
And, of course, [**enaon's apps for the P8**](https://github.com/enaon/eucWatch).
